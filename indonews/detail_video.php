    ...
    <div class="wrapper">
        <div class="container">
            ...
            <?php
                ...
                $id_video = (isset($_GET['id_video']) ? $_GET['id_video'] : '');

                global $kdb;

                $sql = mysqli_query($kdb, "select * from tb_video where id_video = '".$id_video."'");
                while ($b = mysqli_fetch_array($sql)) {
                    extract($b);

                    $Updatelihat = mysqli_query($kdb, "update tb_video set jumlah_lihat = jumlah_lihat + 1 where id_video = '".$id_video."' ");

                    echo '
                        <div class="content detail_video">
        ...
        <div class="lain">
            ...
            <?php
                ...
                $sql = mysqli_query($kdb, "select * from tb_video");
                while ($b = mysqli_fetch_array($sql)) {
                    extract($b);
