...
<head>
    ...
    <link rel="stylesheet" href="assets/berita-list.css">
</head>
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <?php
                ...
                $sql = mysqli_query($kdb, "select * from tb_berita order by id_berita desc");
                while ($b = mysqli_fetch_array($sql)) {
                    ...
                    echo '
                        <div class="content">
                            ...
                            <h2><a href="./?open=detail_berita&id_berita='.$id_berita.'" style="text-decoration: none; color: #000;">'.$judul.'</a></h2>
                            <p class="p-1">'.(substr(strip_tags($isi), 0, 150)).' . . . .</p>
                            <p class="p-2">'.tanggal_indo($tanggal).'</p>
                        </div>
                    ';
                }
