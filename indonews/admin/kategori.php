...
<head>
    ...
    <title>Admin Indonews - Kategori</title>
    ...
    <div id="layoutSidenav">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav mt-3">
                        ...
                        <a class="nav-link mt-3 active" href="kategori.php">
        ...
        <div id="layoutSidenav_content">
            <div class="container-fluid px-5 mt-2">
                <h1 class="mt-5">Data Kategori Berita</h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <table id="datatablesSimple">
                            <thead>
                                <tr>
                                    <th class="align-middle ps-4">Kategori</th>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $get = mysqli_query($kdb, "select * from tb_kategori");
                                    while($ktg = mysqli_fetch_array($get)) {
                                        $id_kategori = $ktg['id_kategori'];
                                        $kategori = $ktg['kategori'];

                                ?>

                                    <tr>
                                        <td class="align-middle ps-4"><?=$kategori;?></td>
                                        <td class="d-flex justify-content-center" style="column-gap: 25px;">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit<?=$id_kategori?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                </svg>
                                            </button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?=$id_kategori?>">
                                            ...
                                            <div class="modal-content p-4">
                                                ...
                                                <form method="post" autocomplete="off">
                                                    ...
                                                    <div class="modal-footer d-flex justify-content-center align-items-center pt-4">
                                                        <button type="submit" class="btn btn-success" style="width: 100px;" name="tambah_ktg">Simpan</button>
                                    ...
                                    <div class="modal" id="edit<?=$id_kategori?>">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                            <div class="modal-content p-4">
                                                <div class="modal-header d-flex justify-content-center align-items-center pb-4">
                                                ...
                                                <form method="post" autocomplete="off">
                                                    <div class="modal-body mt-3 mb-1 pe-5 ps-5">
                                                        ...
                                                        <div class="row mb-3">
                                                            <label class="col-sm-3 col-form-label">Kategori</label>
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control" name="kategori" value="<?=$kategori;?>" require>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer d-flex justify-content-center align-items-center pt-4">
                                                        <button type="submit" class="btn btn-success" style="width: 100px;" name="edit_ktg">Simpan</button>
                                                        <button type="button" class="btn btn-danger" style="width: 100px;" data-bs-dismiss="modal">Batal</button>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content p-4">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body mt-3 mb-1 pe-5 ps-5">
                                                        <div class="row mb-3">
                                                            <input type="hidden" class="form-control" name="id_kategori" value="<?=$id_kategori;?>" readonly>
                                                            <label class="col-sm-3 col-form-label">Kategori</label>
                                                            <div class="col-sm-9">
                                                    ...
                                                    <div class="modal-footer d-flex justify-content-center align-items-center pt-4">
                                                        <button type="submit" class="btn btn-danger" style="width: 100px;" name="hapus_ktg">Hapus</button>
