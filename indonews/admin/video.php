            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav mt-3">
                        ...
                        <a class="nav-link mt-3 active" href="video.php">
                        ...
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    $get = mysqli_query($kdb, "select * from tb_video v, tb_kategori k where v.id_kategori = k.id_kategori order by id_video desc");
                                    while($vid = mysqli_fetch_array($get)) {
                                        $id_video = $vid['id_video'];
                                        $judul = $vid['judul'];
                                        $id_kategori = $vid['id_kategori'];
                                        $kategori = $vid['kategori'];
                                        $video = $vid['video'];
                                        $tanggal = $vid['tanggal'];
                                        $jumlah_lihat = $vid['jumlah_lihat'];
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center" style="column-gap: 25px;">
                                            <button type="button" class="btn btn-primary me-1" data-bs-toggle="modal" data-bs-target="#edit<?=$id_video?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                </svg>
                                            </button>
                                            <button type="button" class="btn btn-danger ms-1" data-bs-toggle="modal" data-bs-target="#hapus<?=$id_video?>">
                                            ...
                                            <div class="modal-content p-4">
                                                ...
                                                <form action="function.php" method="post" enctype="multipart/form-data" autocomplete="off">
                                                    ...
                                                    <div class="modal-footer d-flex justify-content-center align-items-center pt-4">
                                                        <button type="submit" class="btn btn-success" style="width: 100px;" name="tambah_vid">Simpan</button>
                                    ...
                                    <div class="modal" id="edit<?=$id_video?>">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                            <div class="modal-content p-4">
                                                <div class="modal-header d-flex justify-content-center align-items-center pb-4">
                                                ...
                                                <form method="post" enctype="multipart/form-data" autocomplete="off">
                                                    ...
                                                    <div class="modal-footer d-flex justify-content-center align-items-center pt-4">
                                                        <button type="submit" class="btn btn-success" style="width: 100px;" name="edit_vid">Simpan</button>
                                                        <button type="button" class="btn btn-danger" style="width: 100px;" data-bs-dismiss="modal">Batal</button>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="modal" id="hapus<?=$id_video?>">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content p-4">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body mt-3 mb-1 pe-5 ps-5">
                                                        <input type="hidden" class="form-control" name="id_video" value="<?=$id_video;?>" readonly>
                                                        <div class="row mb-3">
                                                            <label class="col-sm-3 col-form-label">Judul</label>
                                                            <div class="col-sm-9">
                                                    ...
                                                    <div class="modal-footer d-flex justify-content-center align-items-center pt-4">
                                                        <button type="submit" class="btn btn-danger" style="width: 100px;" name="hapus_vid">Hapus</button>
